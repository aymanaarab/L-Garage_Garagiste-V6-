...
@section('content')
    ...
    src="{{ asset('storage/' . $vehicule->photo) }}" alt="Photo of {{ $vehicule->marque }}"/>
  </div>
    ...
    <div
      ...
      <div
        ...
        <div class="flex items-center gap-3">
          <img
          src="{{ asset('storage/' . $vehicule->photo) }}" alt="Photo of {{ $vehicule->marque }}"     class="relative inline-block object-cover object-center rounded-full h-9 w-9" />
